...
import { getConfiguration, getPaymentMethods, initiatePayment, submitAdditionalDetails } from "../../app/paymentSlice";

export function Payment() {
  const { type } = useSelector(state => state.payment);
  return (<ConnectedCheckoutContainer type={type} />);
}
...
const mapDispatchToProps = { getConfiguration, getPaymentMethods, initiatePayment, submitAdditionalDetails };
